...
class Tela_Divisao extends StatefulWidget {
  const Tela_Divisao({Key? key}) : super(key: key);

  @override
  _Tela_DivisaoState createState() => _Tela_DivisaoState();
}

class _Tela_DivisaoState extends State<Tela_Divisao> {
  late int _x =10;
  late int _y =2;
...
//MÉTODO PARA REINICIAR OPERAÇÃO E REINICIAR O PLACAR
  void _reiniciaOp(){
    ...
    var randomy = Random().nextInt(11)+1;
    setState(() {

      try{
        while(( randomx < randomy )|| (randomx % randomy != 0)){
    ...
    setState(() {
      if(_scorePositivo >= 4){
        ...
        try{
          ...
          var randomy = Random().nextInt(21)+1;
          while(( randomx < randomy )|| (randomx % randomy != 0))
            randomy =  Random().nextInt(randomx);
        ...
        try{
          ...
          var randomx = Random().nextInt(61);
          var randomy = Random().nextInt(41)+1;
          while(( randomx < randomy )|| (randomx % randomy != 0))
            randomy =  Random().nextInt(randomx);
        ...
        try{
          ...
          var randomy = Random().nextInt(61)+1;
          while(( randomx < randomy )|| (randomx % randomy != 0))
            randomy =  Random().nextInt(randomx);
        ...
        try{
          ...
          var randomy = Random().nextInt(101)+1;
          while(( randomx < randomy )|| (randomx % randomy != 0))
            randomy =  Random().nextInt(randomx);
