...
class Tela_Mult extends StatefulWidget {
  const Tela_Mult({Key? key}) : super(key: key);

  @override
  _Tela_MultState createState() => _Tela_MultState();
}

class _Tela_MultState extends State<Tela_Mult> {
  ...
  void _Multiplica(){
    ...
    if( respUser == a * b ){
      ...
      _scoreNegativo++;
      _scoreAproveitamento =_scorePositivo/(_scorePositivo+_scoreNegativo)*100;
      print("Resposta Correta:   " + '$a' + " X " + '$b ' + " = " + '$result');
                    ...
                    Padding(padding: EdgeInsets.only(top:100),
                      child: Row(
                        children: <Widget> [
                          ...
                          Text(" X ", style: TextStyle(fontSize: 90, fontWeight: FontWeight.bold,color: Colors.white, fontFamily: 'Russo'),),
